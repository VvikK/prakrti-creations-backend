...
const register = asyncHandler(async (req, res) => {
    const { username, password, role, first_name, last_name, email } = req.body; // destructuring the request body
...
const logout = (req, res) => {
    ...
    res.clearCookie('jwt', { httpOnly: true, secure: false }); // SECURE MUST BE SET TO TRUE WHEN USING WITH FRONTEND
